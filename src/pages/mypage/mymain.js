        ...
        <div className='relative w-screen h-screen overflow-hidden'>
            ...
            <div className='fixed top-0 left-0 sm:left-[765px] sm:w-[512px] h-[calc(100vh-3px)] w-full bg-[#F9F8F8] shadow-2xl rounded-[30px] p-6 overflow-y-auto no-scrollbar z-10'>
                <div className='flex flex-col items-center mt-20'>
                    ...
                    <h2 className='mt-4  text-[18px]'>{userInfo ? userInfo.name : '사용자 이름'}</h2>
                    <p className='text-gray-500'>{userInfo ? userInfo.email : '이메일'}</p>
                    <div className='mt-12 bg-[#E7F2EC] p-4 rounded-[20px] w-full text-center'>
                        <span className=''>{userInfo ? `${userInfo.point} 포인트` : '포인트'}</span>
                    </div>
                </div>
