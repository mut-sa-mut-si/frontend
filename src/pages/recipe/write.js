                ...
                <form onSubmit={onSubmit}>
                    ...
                    <div className=''>
                        <button
                            ...
                            className={`w-32 h-11 p-3 ml-2 font-semibold rounded-[30px] focus:outline-none focus:ring-2 border ${
                                category === 'SKIN' ? 'border-[#56C08C] ring-[#56C08C] bg-[#56C08C] text-white' : ''
                            }`}
                            style={{ fontSize: '15px' }}
                        >
                            피부미용
                        ...
                        <button
                            ...
                            className={`w-32 h-11 p-3 ml-8 font-semibold rounded-[30px] focus:outline-none focus:ring-2 border ${
                                category === 'HEALTH' ? 'border-[#56C08C] ring-[#56C08C] bg-[#56C08C] text-white' : ''
                            }`}
                            style={{ fontSize: '15px' }}
                        >
                            헬스
                        ...
                        <button
                            type='button'
                            onClick={() => handleCategoryChange('NUTRIENTS')}
                            className={`w-32 h-11 p-3 ml-8 font-semibold rounded-[30px] focus:outline-none border ${
                                category === 'NUTRIENTS'
                                    ? 'border-[#56C08C] focus:ring-[#56C08C] bg-[#56C08C] text-white'
                                    : ''
                            }`}
                            style={{ fontSize: '15px' }}
                        >
                    ...
                    <div className='flex justify-between mb-4'>
                        ...
                        <button
                            type='submit'
                            className='w-[65%] h-[70px] p-3 bg-[#56C08C] text-white font-semibold rounded-[30px] focus:outline-none focus:ring-2 focus:ring-main-color'
                            style={{ fontSize: '14px' }}
                        >
                            제출하기
                        </button>
