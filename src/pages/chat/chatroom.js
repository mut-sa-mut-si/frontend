...
const Chatroom = () => {
    ...
    const sendMessage = () => {
        if (stompClient.current && stompClient.current.connected && message.trim() && !isSending) {
            ...
            console.error(
                'Failed to send message. WebSocket client is not connected, message is empty, or already sending.'
            );
        }
    };
        ...
        <div className='relative w-screen h-screen overflow-hidden'>
            ...
            <div className='fixed top-0 left-[765px] w-[512px] h-[calc(100vh-3px)] bg-[#F9F8F8] shadow-2xl rounded-[30px] flex flex-col overflow-hidden no-scrollbar z-10'>
                                    ...
                                    <div
                                        ...
                                        className={`mb-4 p-4 ${
                                            msg.owner === 'me'
                                                ...
                                                : 'bg-[#E7F2EC] text-left mr-auto'
                                        } rounded-[30px] w-fit max-w-[60%]`}
                                    >
                                        <div>{msg.message}</div>{' '}
                                        <div>
                ...
                <div className='fixed bottom-0 left-[765px] w-[512px] bg-white border-t p-4 flex'>
                    ...
                    />
                    <button className='w-12 h-12' onClick={sendMessage} disabled={isSending}>
