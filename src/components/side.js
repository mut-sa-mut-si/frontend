...
function Side() {
    ...
    useEffect(() => {
        ...
        if (code) {
            ...
            axios
                .get(`http://27.96.134.123:8080/api/v1/login/kakao/redirect?code=${code}`)
                .then((response) => {
    ...
    return (
        <div className='fixed w-screen h-screen bg-white '>
            ...
            <div className='text-[30px] font-bold ml-8'>새로운 나를 위한</div>
            ...
            <div className='text-[25px] mt-4 text-customGray ml-8 ml-indent'>일일히 찾아다니지 않아도 괜찮아요</div>

            <div className='text-[25px] text-customGray ml-8 ml-indent'>나만의 레시피를 만들어보세요!</div>
